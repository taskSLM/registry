...
We as members, contributors, and maintainers pledge to make participation in the SLM World community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
- Sharing knowledge freely — helping others find the right SLM for their use case
...
- Dismissing or gatekeeping contributions based on a contributor's experience level
- Submitting models or datasets with intentionally misleading information
...
This Code of Conduct applies within all community spaces — GitHub issues, pull requests, discussions, and any other official SLM World communication channels. It also applies when an individual is officially representing the community in public spaces.
...
For enforcement inquiries, open an issue with the label `conduct` or contact the maintainer team directly.

---

*This code of conduct applies to all SLM World spaces. Thank you for helping make this a welcoming community for everyone building with small language models.*
